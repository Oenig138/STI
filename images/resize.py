...
src = Path("C:/STI/images/in")

# Where the results will go
thumbs = Path("C:/STI/images/thumbs"); thumbs.mkdir(parents=True, exist_ok=True)
full = Path("C:/STI/images/full"); full.mkdir(parents=True, exist_ok=True)
