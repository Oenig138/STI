...
??? info "Deep Dive"
	...
	![The bravado sounds empty when the walls are closing in](assets/yawp-trapped.png){ width="360" }
	...
	![Yawp's big dream: Outplaying the skies](assets/yawp-extatic.png){ width="360" }
...
??? info "Mechanical build (lv 5) and PDF download"
	...
	**Suggested Magic Items**
	...
	![Do you really invite this force of nature to your table? There's still time to change your mind.](assets/yawp-tavern.png){ width="480" }
